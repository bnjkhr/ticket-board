...
import type { Ticket, TicketStatus, TicketPriority, Label } from '@/types/ticket';
...
export default function EditTicketModal({ ticket, onClose }: EditTicketModalProps) {
  ...
  const [selectedLabels, setSelectedLabels] = useState<string[]>(ticket.labels);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-lg w-full p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-gray-900">Ticket bearbeiten</h2>
          <button
            onClick={onClose}
